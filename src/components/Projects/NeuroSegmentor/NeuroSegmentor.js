...
import ThumbnailPng from '../../../res/images/neurosegmentor.png'
import SegmentPng from '../../../res/images/neurosim-3d-segments.png';

import './NeuroSegmentor.css'



export default class NeuroSegmentor extends Project{
    constructor(props){
        super(props)
        this.thumbnail=ThumbnailPng
        this.title="Neural Segmentor"
        this.date="2016"
    ...
    renderContentBody(){
        ...
        <>
          <p>
            This is a passion project of mine, but I need to be upfront about a number of things first. The 
          ...
          <p>
            ...
            SpaceCube. The lack of training data motivated me to seek ways to speed up manual 3D volume segmentation, 
            which has inspired some of my other projects. But I still haven't touched this project at all since 2016. 
          </p>
          <br/>
          <p>
            Cremi, on the other hand, completed their drosophola brain scan, segmented 
            it, <a href="https://www.cell.com/cell/fulltext/S0092-8674(18)30787-6">published their data</a>, and 
            even open-sourced a phenomenally cool <a href="https://virtualflybrain.org/">interactive map</a> of the
            full drosophila brain. If you've read all the way to the end of this post, do check out their work. It 
            is so cool.
          </p>
          <br/>
        </>
